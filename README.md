...
**Project**: stockholm-map-lounge 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: A simple Leaflet map centered on Stockholm 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/stockholm-map-lounge.git
cd stockholm-map-lounge
npm i
